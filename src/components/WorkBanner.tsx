            ...
            work.map((item, index) => (
              <SwiperSlide className='rounded-[40px] w-full max-w-[400px] md:!w-[400px] h-[500px] md:h-[600px] p-3 pb-[20px] bg-[#00000033] bg-no-repeat bg-center bg-cover overflow-hidden cursor-pointer relative group' key={index}>
                <Link href={item.url}>
                  ...
                  <div className="absolute bottom-[12px] left-1/2 -translate-x-1/2 flex justify-between w-[calc(100%-24px)] items-center rounded-[32px] border border-[#E6E6E6] p-1 ps-4 backdrop-blur-[7.5px] bg-[#00000066]">
